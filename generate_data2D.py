...
def main(args):
    ...
    h5f = h5py.File(f"/home/cmu/anthony/data_gen/pde_data/2D/{args.split}/{args.equation}_{num_samples}_OOD.h5", 'a')
    ...
    for i in range(3):
        for j in tqdm(range(args.num_samples)):
            ...
            if i == 2:
                ...
                (u, v), grid, times = simulate_burgers(args, nu, cx, cy, i+seed+40000)
                u_downsample = u[:, ::8, ::8]
