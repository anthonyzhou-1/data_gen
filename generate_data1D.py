...
def main(args):
    ...
    h5f = h5py.File(f"/home/cmu/anthony/data_gen/pde_data/1D/{args.split}/{args.equation}_{args.num_samples}.h5", 'a')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--equation', type=str, default='Advection',
                        help='Equation for which data should create for: [Heat, Advection, Burgers]')
